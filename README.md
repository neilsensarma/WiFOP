...
The environments can  be installed using the following command:
'''
conda env create -f wifop-ml.yml
conda env create -f wifop-dl.yml
'''

Once installed the conda environments can be activated and deactivated using the following command:
