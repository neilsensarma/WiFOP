...
def main():
    ...
    f_labels  = FINAL / "labels_CA_2023-7_9.csv"
    f_lookup  = FINAL / "grid_lookup_CA_5km.csv"
    f_irwin   = INTER / "fires" / "cleaned_irwin_CA_2023-7_9.csv"
    f_events  = INTER / "labels" / "events_on_grid_CA_2023-7_9.csv"   # optional
    ...
    bad_date = labels[~labels["date"].between("2023-07-01", "2023-09-30")]
    # 2) fire_today VALUE
