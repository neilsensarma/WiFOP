...
def build_labels():
    ...
    IRWIN_CLEAN  = INTER / "fires" / "cleaned_irwin_CA_2023-7_9.csv"
    ...
    events_out = INTER / "labels" / "events_on_grid_CA_2023-7_9.csv"
    ...
    all_days = pd.date_range("2023-07-01", "2023-09-30", freq="D").strftime("%Y-%m-%d")
    ...
    labels_out = FINAL / "labels_CA_2023-7_9.csv"
