...
IN_CSV  = ROOT / "fire label data" / "data" / "raw" / "ca_2023-07" / "irwin_US-CA_2023-07_PT.csv"

OUT_CSV = ROOT / "fire label data" / "data" / "interim" / "fires" / "cleaned_irwin_CA_2023-07.csv"
